...
export const aspek: IEmployee = new Employee({
  ...
  text: "Один из основателей «Открытой Территории», главный дизайнер, специалист в сфере айдентики и интерфейсов (UX/UI). Закончил первый факультет Рекламы в России (Московский гуманитарный университет). Дизайнер в международном рекламном агентстве, автор множества логотипов, фирменных стилей, сайтов и мобильных приложений. Граффити-райтер, леттерист.",
  type: "admins",
  main: true,
  active: true,
