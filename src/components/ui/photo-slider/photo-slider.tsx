...
import { TPhotoSliderUIProps } from "./types";
...
import styles from "./photo-slider.module.css";

export const PhotoSliderUI: FC<TPhotoSliderUIProps> = ({
  photos,
  currentIndex,
  currentPhoto,
  onMoveLeft,
